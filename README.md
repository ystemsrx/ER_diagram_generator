...
**关系命名:** 标准Chen模型中,菱形(关系)应使用语义化名称(如"属于"、"拥有"),本工具为简化使用,默认显示外键字段名。
...
> 💡 **参考标准示例:** [ER图生成](https://ystemsrx.github.io/ER_diagram_generator/sql2er.html)
...
当代码比较复杂时，可能无法直接生成出令人满意的图，此时可以先点击右上角的**强制对齐**按钮，然后再点击**智能布局**，即可自动整理一个新的布局，理论上此时应当比较整齐，仅需微调即可。

Force2 开关默认处于关闭，如果觉得生成的图比较乱，可以打开此开关再生成一次，它能提供更稳定的结构。
